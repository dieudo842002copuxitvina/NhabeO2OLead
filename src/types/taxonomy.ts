    ...
    children: [
      {
        ...
        children: [
          { id: 'fertilizer-nitrogen', name: 'Phân đạm', slug: 'phan-dam', parentId: 'fertilizer-single-nutrient' },
          {
      ...
      },
      {
        ...
        parentId: 'fertilizer-inorganic',
        children: [
          { id: 'fertilizer-npk', name: 'NPK', slug: 'npk', parentId: 'fertilizer-compound' },
          { id: 'fertilizer-dap-map', name: 'DAP/MAP', slug: 'dap-map', parentId: 'fertilizer-compound' },
          { id: 'fertilizer-nk-pk', name: 'NK/PK', slug: 'nk-pk', parentId: 'fertilizer-compound' },
        ],
      },
      {
    ...
    children: [
      {
        ...
        children: [
          { id: 'fertilizer-base-dressing', name: 'Bón lót', slug: 'bon-lot', parentId: 'fertilizer-soil-application' },
          {
